        ...
        if (this.props.about) {
            jsx = (
                <div style={style}>
                    ...
                    <div Style='border-radius: 50%; overflow: hidden; width: 80px; height: 80px; margin-left: calc(50% - 40px)'>
                    <img className='profile' src={require('./../images/profile.jpeg')} alt={require('./../images/missing.png')} Style='width: 80px; height: auto; transform: translate(0%, -20%)' />
                </div>
